...
var Bitcore_ = {
  btc: Bitcore,
  sprk: require('bitcore-lib-sparkle'),
...
API.prototype.createWallet = function(walletName, copayerName, m, n, opts, cb) {
  ...
  var coin = opts.coin || 'btc';
  if (!_.includes(['btc', 'bch', 'sprk'], coin)) return cb(new Error('Invalid coin'));
...
API.prototype.getBalance = function(opts, cb) {
  ...
  if (opts.coin) {
    if (!_.includes(['btc', 'bch', 'sprk'], opts.coin)) return cb(new Error('Invalid coin'));
